...
function App() {
  ...
  const axioscall = (input,from,to,type) => {
  ...
  var inputs=[
    ...
    'my dad said eat your vegetables',
    'my dad said be yourself'
  ]
  var inputs1=[
    'my dad',
    'my mum',
  ...
  const translate=()=>{
   ...
   inputs1.includes(input)
    if(myArray.includes('my') && myArray.includes('dad')){
      axioscall(love[randomIndex],from,to,1);
  ...
  <div className="row">
    ...
    <div className='card'>
      <b>try:</b>
        ...
        {inputs.map(val=><p key={val}>{val}</p>)}
    </div>
    </div></div></div>
    ...
    <div className="col-sm-12 col-md-12 col-lg-6">
      ...
      <div className="col-sm-12 col-md-12 col-lg-6">
      <StyleRoot>
      <textarea style={styles.bounce}   disabled cols='50' rows='8' value={output} ></textarea>
      </StyleRoot>
      </div>
      </div>
      <div>
      ...
      <div class="container">
        <div class="row">
          ...
          <button className='button-53' onClick={(e) =>translate()}>Translate</button><br/><br/>
        <p>
